...
const auto control_word = x3::lexeme[x3::lit('\\') >> identifier] - x3::lit("\\begin") - x3::lit("\\end") -
                          x3::lit("\\newcommand") - x3::lit("\\newenvironment");
